...
namespace NetworkNode
{
    ...
    public class BorderNodeCommutationTable
    {
        ...
        /// <returns></returns>
        public BorderNodeCommutationTableRow FindRow(string IP_IN, short port_in)
        {
            ...
            try
            {
                ...
                borderRow = this.Table.Find(row => (row.IP_IN.ToString() == IP_IN) && (row.port_in == port_in));
        ...
        public byte[] changePackageHeader(byte[] message)
        {
            ...
            row = this.FindRow(p.IP_Source.ToString(), p.portNumber);
        ...
        /// <param name="port_in"></param>
        /// <returns></returns>
        public int FindIndex(string IP_IN, short port_in)
        {
            int index;
            try
            {
                index = this.Table.FindIndex(r => (r.IP_IN.ToString() == IP_IN) && (r.port_in == port_in));
                return index;
            }
            catch (Exception E)
            {
