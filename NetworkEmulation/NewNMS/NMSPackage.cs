...
{ 
    ...
    public class NMSPackage
    {
        ...
        /// </summary>
        public NMSPackage(string IP_Source, short sourceport, string usableMessage, short usableInfoLength) : this()
        {
        ...
        /// </summary>
        public NMSPackage( int freq_in,string IP_Node2, short sourceport, string usableMessage, short usableInfoLength) : this()
        {
        ...
        public void actualizeBytes()
        {
            ...
            byte[] sourceport_bytes = BitConverter.GetBytes(sourceport);
            ...
            headerBytes.AddRange(sourceport_bytes); //2 
            ...
            headerBytes.AddRange(freq_in_bytes); //4
            ...
            //uzupełnienie zerami
            usableInfoBytes = fillBytesWIth0(40, usableInfoBytes);
        }
        ...
        public static short extractUsableInfoLength(byte[] packageBytes)
        {
            ...
            byte[] bytes = NMSPackage.extract(16, 2, packageBytes);
        ...
        /// <param name="packageBytes"></param>
        /// <returns></returns>
        public static int exctractFreq_in(byte[] packageBytes)
        {
            //Source IP sie zaczyna na 4. pozycji i ma dlugosc 4B
            byte[] bytes = NMSPackage.extract(12, 4, packageBytes);
        ...
        public static short extractSourcePortNumber(byte[] packageBytes)
        {
